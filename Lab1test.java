...
public class Lab1test {
	...
	public static void main(String[] args) {
		...
		ResizeableArrayBag <String> bag3 = new ResizeableArrayBag<> ();
		...
		ResizeableArrayBag <String> u, i;
		
		while  (sc.hasNext())
			bag1.add(sc.nextLine());
		sc.close();
		
		File lioness = new File ("lioness.txt");
		Scanner scan = new Scanner (lioness);
		while (scan.hasNext())
			bag3.add(scan.nextLine());
		scan.close();
		...
		System.out.println(bag3.equals(bag2));
	}
